 ...
 */
#[Fillable(['first_name', 'middle_name', 'last_name', 'extension_name', 'email', 'contact_number', 'role', 'password', 'provider', 'provider_id', 'email_verified_at', 'banned_at', 'ban_reason'])]
